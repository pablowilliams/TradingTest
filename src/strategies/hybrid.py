...
class HybridStrategy(BaseStrategy):
    def __init__(self, bot_id: str, params: dict = None, generation: int = 0):
        defaults = {"high_price_guard": 0.72, "low_price_guard": 0.35, "confidence_cap": 0.85,
                    ...
                    "learning_weight_max": 0.30, "min_agreement": 2}
    ...
    def get_strategy_signal(self, market: dict, signals: dict) -> float:
        ...
        # #70 FIX: lowered from 3 to 2 so momentum vs mean_reversion
        # opposition doesn't block all trades
        min_agree = self.params.get("min_agreement", 2)
